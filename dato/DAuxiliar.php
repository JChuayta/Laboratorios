...
class DAuxiliar
{
    ...
    {
        $this->con->conectar();
        return $this->con->ejecutarConsulta("insert into auxiliar(ci,carrera,codigo,estado,numform,registro,descripcion,tipo) values($this->ci,'$this->carrera','$this->codigo','$this->estado',$this->numform,$this->registro,'$this->descripcion','$this->tipo')");
    }
}
